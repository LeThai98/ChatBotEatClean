...
namespace EchoBot2ML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\HongThaiPC\Desktop\Practice\SentimentText.csv";
        private static string MODEL_FILEPATH = @"C:\Users\HongThaiPC\AppData\Local\Temp\MLVSTools\EchoBot2ML\EchoBot2ML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey("Sentiment", "Sentiment")
                                      .Append(mlContext.Transforms.Text.FeaturizeText("Sentiment_Text_tf", "Sentiment_Text"))
                                      .Append(mlContext.Transforms.CopyColumns("Features", "Sentiment_Text_tf"))
